...
_Última actualización: 2026-09-06 — Sprint 2.4, Fase C._
...
- **32 UVT mensuales** totales (`MONTHLY_CAP_UVT_TOTAL`).
- **384 UVT anuales** totales (`ANNUAL_CAP_UVT_TOTAL`).
...
Motor puro — `packages/aegis-rules/tests/dependents.test.ts` (11 pruebas):
