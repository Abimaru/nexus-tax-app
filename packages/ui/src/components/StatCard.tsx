...
export function StatCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'rounded-2xl border border-overlay/10 bg-surface-glass p-5 backdrop-blur-md',
    ...
    >
      ...
      <AnimatedCounter
        value={value}
        format={format}
        className="mt-2 block text-3xl font-semibold tracking-tight text-content-strong"
      />
